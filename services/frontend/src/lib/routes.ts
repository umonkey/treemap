...
export const routes = {
	...
	search: () => '/search',
	searchResults: (query: string) => build('/search/results', { query }),
	searchAddress: (query: string) => build('/search/results', { query: `addr:"${query}"` }),
	searchQuery: (query: string) => (query ? build('/search/results', { query }) : '/search/results'),
